...
import (
	...
	"open-oauth-center/log"
	"open-oauth-center/models"
	"open-oauth-center/oauth"
	"open-oauth-center/test-util"
...
func (suite *OauthTestSuite) SetupSuite() {
	...
	db, err := testutil.CreateTestDatabaseMysql(
	...
	suite.service = oauth.NewService(suite.cfg, suite.db)
